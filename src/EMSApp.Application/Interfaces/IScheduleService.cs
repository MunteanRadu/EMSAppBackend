...
{
    Task<Schedule> CreateAsync(string departmentId, string managerId, ShiftType shiftType, DayOfWeek day, TimeOnly startTime, TimeOnly endTime, bool isWorkingDay, CancellationToken ct);
